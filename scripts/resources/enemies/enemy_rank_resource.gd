...
@export var elite_drop_chance_mult: float = 1.5
...
@export var super_elite_drop_chance_mult: float = 2.5
...
func get_drop_chance_mult(rank: Rank) -> float:
	match rank:
		Rank.ELITE: return elite_drop_chance_mult
		Rank.SUPER_ELITE: return super_elite_drop_chance_mult
		_: return 1.0
